...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // This will integrate with Keycloak user creation
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join your school community today</p>
        </div>
        ...
        <Card className="border-0 shadow-xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="schoolCode">School Code / UDISE Code</Label>
                <Input
                  id="schoolCode"
                ...
                <p className="text-xs text-gray-500">
                  Contact your school administrator if you don't know this code
                </p>
              </div>
